...
import ru.yandex.practicum.shareit.booking.controller.BookingController;
import ru.yandex.practicum.shareit.item.controller.ItemController;
import ru.yandex.practicum.shareit.user.controller.UserController;
...
public class ErrorsHandler {
    ...
    public ResponseEntity<?> handleResponseStatusExc(final ResponseStatusException e) {
        return new ResponseEntity<>(Map.of(ERROR, Objects.requireNonNull(e.getReason())), e.getStatusCode());
    }
